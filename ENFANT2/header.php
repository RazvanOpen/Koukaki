...
<head>
	...
	<link rel="icon" type="image/png" href="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/VideoImage/logo.png' ); ?>">
	<?php wp_head(); ?>
</head>
	...
	<header id="masthead" class="site-header">
		<nav id="site-navigation" class="main-navigation">
            ...
            <div id="fullScreenMenu" class="fullScreenMenu">
                <div class="fullMenu">
                    <img class="logoMenu" src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/VideoImage/logo.png' ); ?>" alt="logo Fleurs d'oranger & chats errants">
                    <ul>
                ...
                <div class="catsMenu">
                    <img class="Kawaneko" src="<?php echo esc_url( home_url( '/wp-content/uploads/2026/05/cat1.png' ) ); ?>" alt="">
                    <img class="Jaakuna" src="<?php echo esc_url( home_url( '/wp-content/uploads/2026/05/Group-180.png' ) ); ?>" alt="">
                    <img class="Orenjiiro" src="<?php echo esc_url( home_url( '/wp-content/uploads/2026/05/cat.png' ) ); ?>" alt="">
                </div>
            </div>
